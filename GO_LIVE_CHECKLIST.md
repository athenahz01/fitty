...
## 2. Live RLS + consent verification (hard gate)
...
## 3. Keep capture OFF until gate 2 passes
...
## 4. Turn on capture (staging first)
...
## 5. Accumulate consented outcomes
...
## 6. Real-model enablement (hard gate)
